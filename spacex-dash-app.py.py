...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class',
        title='Successful vs. Unsuccessful Launches for Selected Site')
        return fig
...
def get_scatter_chart(entered_site, payload_mass):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df_s = filtered_df_s[filtered_df_s['Launch Site'] == entered_site]
        fig = px.scatter(filtered_df_s,
        x = 'Payload Mass (kg)',
        y = 'class',
        color = 'Booster Version Category',
        title = 'Payload Mass vs. Launch Outcome for Selected Site')
        return fig
